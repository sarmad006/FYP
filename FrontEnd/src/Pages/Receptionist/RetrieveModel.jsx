      ...
      <div className="col-span-10">
          <div className="flex justify-center flex-col items-center space-y-20">
            ...
            <div className="text-white" id ="datadetails">
              ...
              <button className="text-white bg-purple p-3 rounded-full" id="btnsp1" onClick={getModel}>Get INDEX</button>
              <button className="text-white bg-borderPurple p-3 rounded-full" id="btnsp2" onClick={()=>getHash()}>
              Check Hash
              </button>
              </div>
              <div className='selectoptionspd'>
                  {fetch? (
                    ...
                    <option value="">Select an option</option>
                      {hospital.map((option)=>(
                        <option key={option} value={option.metamask}>{option.name}</option>
                      ))}
                    </select>
                    ):(<h1>Not</h1>)}  
